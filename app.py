...
# 🔥 এখানে তুমি নিজের 100+ API যোগ করবে (নিচের স্ট্রাকচার মেনে)
APIS = [
...
# ওয়েব পেজ (স্টাইলিশ, স্টার্ট/স্টপ কাজ করবে)
HTML_PAGE = """
<!DOCTYPE html>
<html>
<head>
...
<div class="glass-card">
    ...
    <div class="sub">⚡ 100+ APIS (আপনি যোগ করুন) | VOICE + WHATSAPP + SMS ⚡<br>🚀 CONCURRENT THREADS | INFINITE LOOP 🚀</div>
    ...
    <button id="startBtn">💣 START UNLIMITED BOMBING (UNTIL STOP) 💣</button>
    <button id="stopBtn">🛑 STOP / RESET 🛑</button>

    <div class="output-box">
        <pre id="output">⚡ রেডি। নম্বর দিন ও START চাপুন। সারাদিন চলবে।</pre>
    </div>
    <div class="badge">🔥 আনলিমিটেড রাউন্ড | প্রতি রাউন্ডে 0.1 সেকেন্ড বিরতি 🔥</div>
...
<script>
    ...
    startBtn.onclick = async () => {
        ...
        while (running) {
            ...
            // 0.1 সেকেন্ড দেরি (চাইলেই কমাতে বা বাড়াতে পারো)
...
def bomb():
    ...
    if not APIS:
        return jsonify({"log": "⚠️ No APIs added. Please add APIs to the APIS list."}), 200
